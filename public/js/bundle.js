...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiempheWVycyIsImEiOiJjazd4cjJsa3YwMDR1M2ZsZW9xZ3R5cHdrIn0.9Hi3ZkkJJshJPI-8zbQxzA';
  ...
  locations.forEach(function (loc) {
    ...
    htmlEl.className = 'marker'; // Add Marker To Map

    new mapboxgl.Marker({
      element: htmlEl,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // Add a tooltip to the marker
...
var alert = _interopRequireWildcard(require("./alerts"));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            alert.showAlert('error', _context.t0.response.data.message);
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"../../utils/capitalize.js":[function(require,module,exports) {
/* eslint-disable */
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            if (res.data.status === 'success') {
              alert.showAlert('success', "".concat(capitalize(type), " updated successfully!"));
            }
...
},{"./../../utils/capitalize":"../../utils/capitalize.js","axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"forgotPassword.js":[function(require,module,exports) {
"use strict";
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_JU1Do1XdzGW66knXE6Qn6oxR00YMsfdSM4');
            _context.prev = 1;
            _context.next = 4;
          ...
          case 9:
            ...
            _alerts.default.showAlert('error', _context.t0);
